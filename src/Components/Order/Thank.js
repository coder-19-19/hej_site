            ...
            <div className="icon-box d-inline-flex align-items-center">
                <div className="icon-box-icon mb-0">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                         ...
                         enable-background="new 0 0 50 50" xmlSpace="preserve">
									<g>
                ...
                <div className="icon-box-content text-left">
                    <h5 className="icon-box-title font-weight-bold lh-1 mb-1">TƏŞƏKKÜRLƏR!</h5>
                    <p className="lh-1 ls-m">Sifarişiniz qeydə alındı</p>
                </div>
            </div>
        </div>
    )
